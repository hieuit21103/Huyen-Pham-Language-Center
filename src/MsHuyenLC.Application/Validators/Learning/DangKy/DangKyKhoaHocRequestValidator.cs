...
public class DangKyKhoaHocRequestValidator : AbstractValidator<DangKyKhoaHocRequest>
{
    private readonly IUnitOfWork _unitOfWork;

    public DangKyKhoaHocRequestValidator(IUnitOfWork unitOfWork)
    {
    ...
    private async Task<bool> NotAlreadyRegistered(DangKyKhoaHocRequest request, CancellationToken cancellationToken)
    {
        return !await _unitOfWork.DangKyKhoaHocs.ExistsAsync(d => 
