...
public class DangKyTuVanUpdateRequestValidator : AbstractValidator<DangKyTuVanUpdateRequest>
{
    private readonly IUnitOfWork _unitOfWork;

    public DangKyTuVanUpdateRequestValidator(IUnitOfWork unitOfWork)
    {
