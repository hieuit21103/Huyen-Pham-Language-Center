...
public class DangKyKhachCreateRequestValidator : AbstractValidator<DangKyKhachCreateRequest>
{
    private readonly IUnitOfWork _unitOfWork;

    public DangKyKhachCreateRequestValidator(IUnitOfWork unitOfWork)
    {
