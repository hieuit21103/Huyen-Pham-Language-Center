...
public class PhanCongRequestValidator : AbstractValidator<PhanCongRequest>
{
    private readonly IUnitOfWork _unitOfWork;

    public PhanCongRequestValidator(IUnitOfWork unitOfWork)
    {
    ...
    private async Task<bool> NotAlreadyAssigned(PhanCongRequest request, CancellationToken cancellationToken)
    {
