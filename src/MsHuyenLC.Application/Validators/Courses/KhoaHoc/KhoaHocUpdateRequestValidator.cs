...
public class KhoaHocUpdateRequestValidator : AbstractValidator<KhoaHocUpdateRequest>
{
    public KhoaHocUpdateRequestValidator()
    {
        ...
        RuleFor(x => x.NgayKhaiGiang)
            .NotEmpty().WithMessage("Ngày khai giảng không được để trống");
