...
[ApiController]
public class DangKyTuVanController : BaseController
{
    ...
    public async Task<IActionResult> GetAll()
    {
        ...
        var response = entities.Select(dk => new DangKyTuVanResponse
        {
            Id = dk.Id,
            HoTen = dk.HoTen,
    ...
    public async Task<IActionResult> GetById(string id)
    {
        ...
        var response = new DangKyTuVanResponse
        {
            Id = entity.Id,
            HoTen = entity.HoTen,
    ...
    [HttpPost("register")]
    [AllowAnonymous]
    public async Task<IActionResult> GuestRegister([FromBody] DangKyTuVanRequest request)
    {
    ...
    [HttpPost("create")]
    [Authorize(Roles = "admin,giaovu")]
    public async Task<IActionResult> CreateByAdmin([FromBody] DangKyTuVanCreateRequest request)
    {
        if (!ModelState.IsValid)
            return BadRequest(new
            {
    ...
    [HttpPut("{id}")]
    [Authorize(Roles = "admin,giaovu")]
    public async Task<IActionResult> Update(string id, [FromBody] DangKyTuVanUpdateRequest request)
    {
        if (!ModelState.IsValid)
            return BadRequest(new
            {
